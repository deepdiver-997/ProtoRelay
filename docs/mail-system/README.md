...
| 文档 | 内容 |
|------|------|
| [bugfixes/2026-09-06-stmt-truncated-refetch-uaf.md](bugfixes/2026-09-06-stmt-truncated-refetch-uaf.md) | ASan soak 三连：stmt 截断重取 UAF（tcache 连环崩溃根因）+ 会话生命周期 UAF + close 同步 SSL_shutdown 阻塞 |
